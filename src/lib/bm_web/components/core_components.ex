defmodule BmWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BmWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BmWeb.Gettext, "errors", msg, opts)
    end
  end
